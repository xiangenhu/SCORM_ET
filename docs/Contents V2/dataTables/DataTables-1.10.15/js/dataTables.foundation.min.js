...
(function (d) {
    ...
    a.ext.foundationVersion = b.css("font-family").match(/small|medium|large/) ? 6 : 5;
    b.remove();
    ...
    a.ext.renderer.pageButton.foundation = function (b, l, r, s, e, i) {
        var m = new a.Api(b),
            ...
            f, h, g, v = 5 === a.ext.foundationVersion,
            q = function (a, n) {
                ...
                for (o = n.length; k < o; k++)
                    if (c = n[k], d.isArray(c)) q(a, c);
                        ...
                        case "last":
                            ...
                            break;
                        default:
                            f = c + 1, h = e === c ? "current" : "", g = e === c ? null : "a"
                        }
                        v && (g = "a");
                        f && (p = d("<li>", {
                            ...
                            id: 0 === r && "string" === typeof c ? b.sTableId + "_" + c : null
                        }).append(g ? d("<" + g + "/>", {
                            href: "#"
                        }).html(f) : f).appendTo(a), b.oApi._fnBindAction(p, {
                            action: c
                        }, l))
                    }
            };
