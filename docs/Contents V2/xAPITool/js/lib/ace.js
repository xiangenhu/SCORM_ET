    ...
    o(e)
        ...
        (function () {
            r.implement(this, i), this.getPosition = function () {
                ...
                else t.action === "insertLines" ? s.row <= r && (r += o.row - s.row) : t.action === "removeText" ? s.row === r && s.column < i ? o.column >= i ? i = s.column : i = Math.max(0, i - (o.column - s.column)) : s.row !== o.row && s.row < r ? (o.row === r && (i = Math.max(0, i - o.column) + s.column), r -= o.row - s.row) : o.row === r && (r -= o.row - s.row, i = Math.max(0, i - o.column) + s.column) : t.action == "removeLines" && s.row <= r && (o.row <= r ? r -= o.row - s.row : (r = s.row, i = 0));
                ...
                for (var t in this.states) {
                    ...
                    for (var a = 0; a < n.length; a++) {
                        ...
                        if (Array.isArray(f.token))
                            if (f.token.length == 1 || c == 1) f.token = f.token[0];
                            else {
        ...
        (function () {
            this.$setMaxTokenCount = function (e) {
                ...
                while (a = u.exec(e)) {
                    ...
                    if (d)
                        if (typeof h == "string") !!p && p.merge === !1 || c.type !== h ? (c.type && f.push(c), c = {
                            type: h,
                            value: d
                        }) : c.value += d;
                        else if (h) {
                    ...
                    l = v;
                    if (f.length > r) {
                        while (l < e.length) c.type && f.push(c), c = {
        ...
        (function () {
            this.set = function (e) {
                ...
                var i = this,
                    o, u = t.backwards;
                if (t.$isMultiLine) var a = n.length,
                    f = function (t, r, i) {
                        var u = t.search(n[0]);
                        if (u == -1) return;
                        for (var f = 1; f < a; f++) {
        ...
        (function () {
            this.addCommand = function (e) {
                ...
                for (var r in n)
                    for (var i in n[r]) n[r][i] == e && delete n[r][i]
        ...
        t.commands = [{
            ...
            bindKey: s("Alt-Shift-E", "Ctrl-Shift-E"),
            exec: function (e) {
                i.loadModule("ace/ext/error_marker", function (t) {
                    t.showErrorMarker(e, -1)
                })
        ...
        var m = function (e, t) {
            ...
            this.canvas = r.element, this.$markerFront = new u(this.content), this.$cursorLayer = new f(this.content), this.$horizScroll = !1, this.$vScroll = !1, this.scrollBar = this.scrollBarV = new c(this.container, this), this.scrollBarH = new l(this.container, this), this.scrollBarV.addEventListener("scroll", function (e) {
                ...
                v: 0,
                h: 0
            }, this.$loop = new h(this.$renderChanges.bind(this), this.container.ownerDocument.defaultView), this.$loop.schedule(this.CHANGE_FULL), this.updateCharacterSize(), this.setPadding(4), s.resetOptions(this), s._emit("renderer", this)
        };
        (function () {
            this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, r.implement(this, d), this.updateCharacterSize = function () {
                ...
                var l = !n && (this.$vScrollBarAlwaysVisible || t.scrollerHeight - i < 0),
                    c = this.$vScroll !== l;
                ...
                var h = Math.ceil(o / this.lineHeight) - 1,
                    p = Math.max(0, Math.round((this.scrollTop - s) / this.lineHeight)),
                    d = p + h,
                    v, m, g = this.lineHeight;
                ...
                if (this.displayIndentGuides) {
                    ...
                    if (this.showInvisibles) {
                        ...
                        var i = s.stringRepeat(this.SPACE_CHAR, this.tabSize),
                            o = this.TAB_CHAR + s.stringRepeat("\xa0", this.tabSize - 1)
                    } else var i = s.stringRepeat("\xa0", this.tabSize),
                        o = i;
        ...
        (function () {
            this.onMouseDown = function (e) {
                ...
                var t = this.editor,
                    n = this.mousedownEvent.getShiftKey();
        ...
        var r = e("../lib/oop"),
            ...
            o = e("../lib/event_emitter").EventEmitter,
            u = 0,
            a = t.FontMetrics = function (e, t) {
                this.el = i.createElement("div"), this.$setMeasureNodeStyles(this.el.style, !0), this.$main = i.createElement("div"), this.$setMeasureNodeStyles(this.$main.style), this.$measureNode = i.createElement("div"), this.$setMeasureNodeStyles(this.$measureNode.style), this.el.appendChild(this.$main), this.el.appendChild(this.$measureNode), e.appendChild(this.el), u || this.$testFractionalRect(), this.$measureNode.textContent = s.stringRepeat("X", u), this.$characterSize = {
                    width: 0,
                    height: 0
                }, this.checkForSizeChanges()
            };
        (function () {
            r.implement(this, o), this.$characterSize = {
                width: 0,
                height: 0
                ...
                var e = this.$measureNode.getBoundingClientRect(),
                    t = {
                        height: e.height,
                        width: e.width / u
                    };
        ...
        var r = e("../lib/event"),
            ...
            a = function (e, t) {
                ...
                var L = !1,
                    A = function (e) {
                        k && (e = k(e), k = null), c ? (b(), e && t.onPaste(e), c = !1) : e == a.charAt(0) ? L ? t.execCommand("del", {
                            source: "ace"
                        }) : t.execCommand("backspace", {
                            source: "ace"
                        }) : (e.substring(0, 2) == a ? e = e.substr(2) : e.charAt(0) == a.charAt(0) ? e = e.substr(1) : e.charAt(e.length - 1) == a.charAt(0) && (e = e.slice(0, -1)), e.charAt(e.length - 1) == a.charAt(0) && (e = e.slice(0, -1)), e && t.onTextInput(e)), L && (L = !1)
                    },
                    O = function (e) {
                        if (h) return;
                        var t = n.value;
        ...
        (function () {
            this.updateSelectionMarkers = function () {
                ...
                var r = this.session,
                    i = this.selection,
                    o = i.rangeList,
                    u, a = i._eventRegistry;
                i._eventRegistry = {};
                var f = new s(r);
                this.inVirtualSelectionMode = !0;
                for (var l = o.ranges.length; l--;) {
                    if (n)
                        while (l > 0 && o.ranges[l].start.row == o.ranges[l - 1].end.row) l--;
        ...
        var r = e("../lib/oop"),
            ...
            o = function (t, n, r, i) {
                ...
                if (s.get("packaged") || !e.toUrl) i = i || s.moduleUrl(n, "worker");
                else {
        ...
        var r = e("ace/line_widgets").LineWidgets,
            i = e("ace/lib/dom"),
            s = e("ace/range").Range;
